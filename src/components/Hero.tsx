...
const Hero = () => {
 ...
 const downloadResume = () => {
  ...
  link.href = 'https://raw.githubusercontent.com/umangkumar612/resume/main/umang.FSWD.pdf';
  link.download = 'Umang_Kumar_Resume.pdf'; // File name that appears when user downloads
  link.click();
};
        ...
        <div className="text-center">
          <div className="animate-fade-in-up">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
              A passionate Computer Science and Engineering student at Galgotias University, crafting digital experiences with code
            </p>
