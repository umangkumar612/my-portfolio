      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Building clean, scalable, and robust applications using modern tools and technologies.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
          {skills.map((skill, index) => (
            ...
            >
              <div className={`bg-gradient-to-r ${skill.color} p-4 rounded-full w-16 h-16 flex items-center justify-center mb-4 shadow-md hover:scale-110 transition`}>
